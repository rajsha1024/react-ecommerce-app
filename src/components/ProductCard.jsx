...
export default function ProductCard({ id, title, price, image, category, rating, inStock, isWishlisted = false, onAddToCart, onToggleWishlist, onViewDetails }) {
    ...
    <div className="relative flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all hover:shadow-md">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="mt-auto pt-4 flex items-center justify-between">
          ...
          className="absolute right-2 top-2 z-20 rounded-full bg-white/80 p-2 shadow-sm transition hover:bg-white"
