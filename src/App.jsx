...
export default function App() {
  ...
  // category toggel checkbox function
  ...
  // optimize filter and shorting using useMemo
  const filteredAndSortedProducts = useMemo(() => {
  let result = [...products]; // Created a copy of products because sort function mutate the orignal array value.
  // 1. Category Filter
